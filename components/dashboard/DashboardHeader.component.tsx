      ...
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0">
          ...
          <div className="flex flex-wrap items-center gap-2 mt-1">
            {organizationName && (
              <span className="inline-block text-[10px] font-black bg-emerald-500/15 text-emerald-300 px-2 py-0.5 rounded-full uppercase tracking-tighter border border-emerald-500/30">
                {organizationName}
              </span>
            )}
            {isOrganizationAdmin && (
